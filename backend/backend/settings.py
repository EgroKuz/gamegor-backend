...
# CSRF_COOKIE_HTTPONLY = False  # Set to False so JS can read it for API requests
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'game_aggregator'),
        'USER': os.getenv('DB_USER', 'postgres'),
        'PASSWORD': os.getenv('DB_PASSWORD'),  # из .env
...
OLLAMA_MODEL = os.getenv("OLLAMA_MODEL_NAME", "qwen2.5:3b")
